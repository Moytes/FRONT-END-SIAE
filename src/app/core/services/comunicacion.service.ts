...
export class ComunicacionService {
  ...
  getSchools(): Observable<School[]> {
    return this.api.get<any[]>('api/comunicacion/escuelas').pipe(
  ...
  getSchoolYears(onlyActive?: boolean): Observable<SchoolYear[]> {
    ...
    return this.api.get<SchoolYear[]>(`api/comunicacion/ciclos-escolares${qs}`);
  }
  ...
  getGroups(schoolId?: string, schoolYearId?: string): Observable<Group[]> {
    ...
    return this.api.get<any[]>(`api/comunicacion/grupos${qs}`).pipe(
  ...
  getStudents(search?: string, schoolId?: string, groupId?: string): Observable<StudentListItem[]> {
    ...
    return this.api.get<any[]>(`api/comunicacion/alumnos${qs}`).pipe(
