...
export class AprendizajeService {
  ...
  getSchools(): Observable<School[]> {
    return this.api.get<any[]>('api/aprendizaje/escuelas').pipe(
  ...
  getSchoolYears(onlyActive?: boolean): Observable<SchoolYear[]> {
    ...
    return this.api.get<SchoolYear[]>(`api/aprendizaje/ciclos-escolares${qs}`);
  }
  ...
  getGroups(schoolId?: string, schoolYearId?: string): Observable<Group[]> {
    ...
    return this.api.get<any[]>(`api/aprendizaje/grupos${qs}`).pipe(
  ...
  getStudents(search?: string, schoolId?: string, groupId?: string): Observable<StudentListItem[]> {
    ...
    return this.api.get<any[]>(`api/aprendizaje/alumnos${qs}`).pipe(
